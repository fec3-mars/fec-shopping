      ...
      <form className="add-to-cart">
        <div className="select-menus" >
          <div className="size-select-container">
            ...
            <select value={this.state.selectedSize} name="size" className="size-input" onChange={(e) => { this.changeState(e) }} >
        ...
        <div className="addToBag-Rate">
          <button onClick={(e) => { this.addToBagHandler(e) }} className="btn__add-to-bag"><span>ADD TO BAG</span><FontAwesomeIcon icon={faPlus} color="black" ></FontAwesomeIcon></button>
